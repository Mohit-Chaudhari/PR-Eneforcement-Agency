...
@Component({
  selector: 'app-manage-movable-prop',
  templateUrl: './manage-movable-prop.component.html',
  styleUrls: ['./manage-movable-prop.component.css']
})
export class ManageMovablePropComponent implements OnInit {
